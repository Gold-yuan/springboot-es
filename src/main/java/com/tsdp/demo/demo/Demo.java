...
//         
        ...
        // 设置要查询的字段中含有关键字
        builder.must(new QueryStringQueryBuilder("enterpriseName").field("智信"));

        // 排序
        FieldSortBuilder sort = SortBuilders.fieldSort("licenseNumber").order(SortOrder.DESC);
