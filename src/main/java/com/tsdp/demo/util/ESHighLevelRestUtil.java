...
public class ESHighLevelRestUtil {
    private Logger logger = LoggerFactory.getLogger(ESHighLevelRestUtil.class);
     ...
     */
    public List<Map<String, Object>> search(QueryBuilder query, String... index) {
     ...
     * @throws Exception
     */
    public boolean indexCreate(String index, String indexType, String propertyJson) throws Exception {
        if (existIndex(index)) {
            logger.info("索引已存在");
        }
...
//        request.alias(new Alias(index + indexType));
     ...
     * @throws Exception
     */
    public boolean indexCreate(String index, String indexType, Map<String, Object> properties) throws Exception {
